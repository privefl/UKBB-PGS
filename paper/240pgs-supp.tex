...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
	\end{tabular}
	\caption{Estimates of SNP heritability $h^2$ and proportion of causal variants $p$ from LDpred2-auto, when using either HapMap3 variants or when prioritizing 1M variants out of 8M+ common variants, for eight phenotypes. Quantiles of all estimates are also reported. \label{tab:ldpred2-est-large}}
\end{table}
