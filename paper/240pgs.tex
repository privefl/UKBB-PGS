...
\subsection*{Including more variants? [MERGE WITH MULTIPLE ANCESTRY?]}
...
Figures \ref{fig:heritability-quant} and \ref{fig:heritability-binary} reports heritability estimates from LDpred2-auto from quantitative and binary traits.
