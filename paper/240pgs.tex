...
First, this enables us to use a different scaling for genotypes. It is assumed by default that variants in $G$ are scaled. By using $\lambda_j \propto 1 / \text{sd}_j$, this [COMPLETE].
