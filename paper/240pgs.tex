...
Running each model takes between a few minutes and a few days depending on the number of non-zero effects (Figure\ref{fig:timings-plr}).

LDpred2-auto completed under seven hours for most phenotypes (Figure \ref{fig:timings-ldpred2}).
