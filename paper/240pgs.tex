...
\noindent All code used for this paper (links to the code used for the two supplementary notes are provided there), \url{https://github.com/privefl/UKBB-PGS/tree/master/code}

\noindent Code to reproduce our nine ancestry groups, \url{https://github.com/privefl/UKBB-PGS#code-to-reproduce-ancestry-groups}
